...
import { summary, workExperince, projects, skills } from './constant';
  ...
  return (
    <div className="overflow-x-hidden overflow-y-hidden">
      ...
      <div className="w-screen h-screen flex flex-col items-center justify-center bg-[#171A21]" ref={heroRef} id='hero'>
        ...
        <h3 className="text-[#c7d5e0] text-2xl">I am Moh Alief Rizky Ramadhan</h3>
        <h4 className="text-[#c7d5e0] text-3xl">A Software Engineer</h4>
        <Separator className="max-w-[20%] mt-3"/>
        <Button className="mt-3 bg-[#2a475e] hover:bg-[#1b2838] duration-300" onClick={() => scrollToRef(homeRef)} aria-label="Scroll to home section">Get To Know Me 👇</Button>
    </div>
      <div className="flex flex-col-reverse lg:flex-row p-5 justify-end gap-4 lg:justify-around items-center mt-10 h-screen" ref={homeRef} id='home'>
        <div className='lg:max-w-[40%]'>
          ...
          <p className='text-sm lg:text-lg text-justify'>{summary}</p>
        </div>
        <img src="/profile.jpg" alt="Profile picture of Moh Alief Rizky Ramadhan" className='max-w-[30%] rounded-full'/>
      </div>
      <div className='mt-5'>
        {/* <!-- component --> */}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-3 gap-3'>
            {projects.map((project) => (
                <Card key={project.title}>
                    <CardTitle>
                        <img src={project.image} alt={`Screenshot or logo for ${project.title} project`} />
                    </CardTitle>
                    <CardContent className='p-4'>
                        ...
                        <p className='text-justify'>
                            ...
                            {project.links.map((link, index) => (
                                <span key={link.url}>
                                    <a href={link.url} target='_blank' rel="noopener noreferrer" className='cursor-pointer underline'>{link.text}</a>
      ...
      <div className='bg-[#171a21] p-5 text-white' ref={contactRef}>
          ...
          <h5 className='mb-3'>
            <a href="mailto:maliefrr14@gmail.com">
              <div className="flex items-center gap-2">
                <img src="/email.svg" alt="Email icon" width={20}/>
            ...
            <h5 className='mb-3'>
              <a href="https://wa.me/+6285156684730">
                <div className="flex items-center gap-2">
                  <img src="/phone-call.svg" alt="Phone icon" width={20}/>
                  +6285156684730
                </div>
              </a>
            </h5>
            <h5>
                <div className="flex items-start gap-2">
                  <img src="/location-pin.svg" alt="Location icon" width={20}/>
                  <div>
        ...
        <div className="w-full">
                    <div className="flex items-center justify-center mb-2">
                        {/* <!-- instagram --> */}
                        <button onClick={() => window.open('https://instagram.com/maliefrr', '_blank')} className="w-9 h-9 flex justify-center items-center border border-slate-300 mr-3 rounded-full hover:border-[#cd486b] hover:bg-[#cd486b] hover:text-white transition duration-300" aria-label="Visit Instagram profile">
                        ...
                        {/* <!-- linkedin --> */}
                        <button onClick={() => window.open('https://www.linkedin.com/in/maliefrr/', '_blank')} className="w-9 h-9 flex justify-center items-center border border-slate-300 mr-3 rounded-full hover:border-sky-500 hover:bg-sky-600 hover:text-white transition duration-300" aria-label="Visit LinkedIn profile">
                        ...
                        {/* <!-- github --> */}
                        <button onClick={() => window.open('https://github.com/maliefrr', '_blank')} className="w-9 h-9 flex justify-center items-center border border-slate-300 mr-3 rounded-full hover:border-[#1b2838] hover:bg-[#1b2838] hover:text-white transition duration-300" aria-label="Visit GitHub profile">
